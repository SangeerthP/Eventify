...
//! Search input ----------------------------------------------------------------
  ...
  return (
    ...
    <Link to={'/createEvent'}>
  <div className='hidden md:flex flex-col place-items-center py-1 px-2 rounded text-green-500 cursor-pointer hover:text-green-600 hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
    <button>
    ...
    <div className='font-bold text-green-500 text-sm'>Create Event</div>
  </div>
</Link>
  ...
  <button onClick={logout} className="secondary text-green-500 hover:text-green-600">
    <div>Log out</div>
    <RxExit className="text-green-500" />
  </button>
</div>
        ...
        {!user &&(
          <div>
            ...
            <Link to={'/login'}>
  <button className="primary text-green-500 border border-green-500 hover:bg-green-500 hover:text-white">
    <div>Sign in</div>
  </button>
</Link>
