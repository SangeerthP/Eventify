  ...
  return (
    <div className="p-4 md:mx-16">
      <div className=" rounded p-2">
        ...
        <button className="text-green-500" onClick={() => setCurrentMonth((prevMonth) => addMonths(prevMonth, -1))}>
                ...
                {events
                  ...
                  .map((event) => (
                    <div key={event._id} className="mt-0 flex md:mt-2">
                      ...
                      <div className="text-white bg-green-500 rounded p-1 font-bold text-xs md:text-base md:p-2">{event.title.toUpperCase()}</div>
